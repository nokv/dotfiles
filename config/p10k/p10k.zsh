...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%5F'    # purple: starship git_branch (branch名/ahead/behind/stash)
      local   modified='%1F'    # red: starship git_status (staged +, unstaged !)
      local  untracked='%1F'    # red: starship git_status (untracked ?)
      local conflicted='%1F'    # red: starship git_status (conflict ~, action)
    else
